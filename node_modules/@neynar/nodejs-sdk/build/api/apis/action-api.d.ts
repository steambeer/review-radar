...
export declare const ActionApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    publishFarcasterAction: (farcasterActionReqBody: FarcasterActionReqBody, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const ActionApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    publishFarcasterAction(farcasterActionReqBody: FarcasterActionReqBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{
        [key: string]: any;
    }>>;
};
/**
