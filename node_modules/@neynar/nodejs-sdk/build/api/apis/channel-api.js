...
const ChannelApiAxiosParamCreator = function (configuration) {
    return {
         ...
         *
         */
        searchChannels: async (q, limit, cursor, viewerFid, options = {}) => {
...
const ChannelApiFp = function (configuration) {
    ...
    return {
         ...
         *
         */
        async searchChannels(q, limit, cursor, viewerFid, options) {
            var _a, _b, _c;
...
class ChannelApi extends base_1.BaseAPI {
     ...
     */
    searchChannels(requestParameters, options) {
        return (0, exports.ChannelApiFp)(this.configuration).searchChannels(requestParameters.q, requestParameters.limit, requestParameters.cursor, requestParameters.viewerFid, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Unfollow a channel
     * @summary Unfollow a channel
