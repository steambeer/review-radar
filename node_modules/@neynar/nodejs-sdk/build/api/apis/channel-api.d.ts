...
export declare const ChannelApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    searchChannels: (q: string, limit?: number, cursor?: string, viewerFid?: number, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
     * Unfollow a channel
...
export declare const ChannelApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    searchChannels(q: string, limit?: number, cursor?: string, viewerFid?: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ChannelSearchResponse>>;
    /**
     * Unfollow a channel
     * @summary Unfollow a channel
     * @param {ChannelFollowReqBody} channelFollowReqBody
