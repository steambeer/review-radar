...
export declare const FrameNotificationTokensNotificationTokensInnerObjectEnum: {
    readonly NotificationToken: "notification_token";
};
...
export declare const FrameNotificationTokensNotificationTokensInnerStatusEnum: {
