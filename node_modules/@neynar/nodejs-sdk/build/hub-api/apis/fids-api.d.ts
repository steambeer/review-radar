...
export declare const FidsApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    fetchFids: (shardId: number, pageSize?: number, reverse?: boolean, pageToken?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const FidsApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    fetchFids(shardId: number, pageSize?: number, reverse?: boolean, pageToken?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FidsResponse>>;
};
/**
