...
export declare const InfoApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    lookupHubInfo: (dbstats: boolean, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const InfoApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    lookupHubInfo(dbstats: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<HubInfoResponse>>;
};
/**
...
export declare class InfoApi extends BaseAPI implements InfoApiInterface {
     ...
     *
     */
    lookupHubInfo(requestParameters: InfoApiLookupHubInfoRequest, options?: RawAxiosRequestConfig): Promise<import("axios").AxiosResponse<HubInfoResponse, any>>;
}
